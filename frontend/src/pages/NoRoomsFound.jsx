            ...
            <div className={`mt-12 transition-all duration-1000 delay-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              <div className="flex flex-col sm:flex-row justify-center items-center space-y-4 sm:space-y-0 sm:space-x-6">
                ...
                <div className="transform hover:scale-105 transition-all duration-300">
                  <Link
                    to="/uploadrooms"
                    className="group relative inline-flex items-center justify-center px-8 py-4 overflow-hidden font-medium text-white border-2 border-green-500 rounded-lg hover:bg-green-500 transition-all duration-300"
                  >
                    <FaPlus className="mr-2 h-5 w-5" />
                    <span className="relative z-10">Add New Room</span>
                  </Link>
                </div>
              </div>
            </div>
