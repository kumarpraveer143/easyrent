...
const ArchievedRenters = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white">
      {/* Header Section */}
      <div className="bg-gradient-to-br from-gray-900 via-red-900 to-orange-900 py-12 relative overflow-hidden pt-24">
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute top-0 right-0 w-72 h-72 bg-orange-500 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-pulse" style={{animationDelay: '2s'}}></div>
        </div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <div className="flex items-center justify-center mb-6">
              ...
              >
                <FaArrowLeft className="h-5 w-5 text-red-400 group-hover:scale-110 transition-transform duration-300" />
              </button>
            ...
            <p className="mt-4 max-w-2xl text-lg text-gray-300 sm:text-xl mx-auto">
              View and manage your archived tenant records
            </p>
            <div className="mt-6 inline-flex items-center px-4 py-2 bg-red-600 bg-opacity-20 rounded-full border border-red-500">
...
const ArchivedRenterCard = ({ renter, onCheckHistory, onRemoveRenter }) => {
  ...
  return (
    <div className="group bg-gray-800 rounded-2xl shadow-2xl overflow-hidden border border-gray-700 hover:border-red-500 transition-all duration-500 transform hover:-translate-y-2">
      {/* Card Header */}
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-red-100">Archived Tenant</p>
            </div>
          </div>
          <div className="text-right">
            ...
            <div className="text-red-100 capitalize">{roomDetails.roomType}</div>
          </div>
        </div>
      </div>
      ...
      <div className="p-6 space-y-4">
        ...
        <div className="bg-gray-700 rounded-lg p-4">
          <div className="flex items-center space-x-3 mb-3">
            <FaHome className="h-5 w-5 text-red-400" />
            <h3 className="text-lg font-semibold text-white">Room Information</h3>
          </div>
          <div className="grid grid-cols-2 gap-4">
            <div className="flex items-center space-x-3">
              <FaBed className="h-5 w-5 text-red-400 flex-shrink-0" />
              <div>
            ...
            <div className="flex items-center space-x-3">
              <FaMoneyBillWave className="h-5 w-5 text-orange-400 flex-shrink-0" />
              <div>
      ...
      <div className="bg-gray-700 p-4 space-y-3">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          ...
          >
            ...
            <span className="text-sm">Permanently Remove</span>
          </button>
        </div>
      </div>
    </div>
